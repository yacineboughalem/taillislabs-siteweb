                ...
                <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" data-trigger name="collections[]" id="choices-single-default" multiple>
                            ...
                            <option 
                                value="{{$cat->id}}" 
                                @if($selectedCollections) {{ in_array( $cat->id , $selectedCollections ) ? "selected" : ""}} @endif
                                > 
                                {{$cat->name}} 
                            </option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="short" class="form-control">{{ old('short') ?? $post->short }}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Body</label>
                        <textarea id="pc-tinymce" name="body" class="tox-target textarea">{{ old('body') ?? $post->body }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/posts/' . $post->image) }}" id="profile-imgsrc" class="img-responsive  mt-2" style="height:200px;">
                    ...
                    <div class="form-group">
                        <div class="form-check form-switch custom-switch-v1 mb-2">
                            <input type="checkbox" name="status" class="form-check-input input-light-primary"
                                id="customswitchlightv1-1" {{ $post->status = true ? 'checked' : '' }}>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="meta_keywords" value="{{ old('meta_keywords') ?? $post->meta_keywords  }}">
                        {{-- <small class="form-text text-muted">Please enter your full name</small> --}}
                    </div>
                    <div class="form-group">
                        <label class="form-label">Meta Description</label>
                        <textarea class="form-control" name="meta_description">{{ old('meta_description') ?? $post->meta_description  }}</textarea>
                        {{-- <small class="form-text text-muted">Please enter your full name</small> --}}
                    </div>
                </div>
            </div>
